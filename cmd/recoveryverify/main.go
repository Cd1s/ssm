// Command recoveryverify is a temporary, exact-purpose verifier for the v2.0.0
...
const (
	expectedCommit = "10417d0e235eff9b22081765b0ad17b75cf74990"
	expectedRun    = "https://github.com/Cd1s/ssm/actions/runs/30911029600/attempts/1"
	expectedRef    = "refs/tags/v2.0.0"
)
...
func main() {
	...
	if err := provenance.VerifyPublicGoodBundle(context.Background(), bundle, provenance.Request{
		AssetName: baseName(os.Args[1]), Version: "v2.0.0", Digest: digest,
	}); err != nil {
		fatal(err)
	}
...
func verifyPredicate(bundle []byte) error {
	...
	if b.BuildType != "https://actions.github.io/buildtypes/workflow/v1" ||
		...
		r.Builder.ID != "https://github.com/Cd1s/ssm/.github/workflows/release.yml@refs/tags/v2.0.0" || r.Metadata.InvocationID != expectedRun ||
		len(b.ResolvedDependencies) != 1 || b.ResolvedDependencies[0].URI != "git+https://github.com/Cd1s/ssm@refs/tags/v2.0.0" ||
		len(b.ResolvedDependencies[0].Digest) != 1 || b.ResolvedDependencies[0].Digest["gitCommit"] != expectedCommit {
		return errors.New("signed provenance predicate is not the exact authorized v2.0.0 build")
	}
	return nil
}
