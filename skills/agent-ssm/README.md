...
The official skill targets the current GitHub latest `ssm`/`sshctl` v2.0.2
binary. It also supports the previous v2.0.1 and v2.0.0 patches and exact
...
The current v2.0.2 is latest, but ordinary updates remain same-major. A v1.4.3
...
│   ├── request-v1.schema.json       # v2.0.0/v2.0.1/v2.0.2 typed request schema v1
